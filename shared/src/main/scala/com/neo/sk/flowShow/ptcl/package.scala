...
package object ptcl {
  ...
  case class NowInfo(onlineSum:List[(String, Long)], inSum: Int, outSum: Int, oldSum: Int, pastOnline: List[(Long, Int)], walkSum: Int) extends WebSocketMsg

  case object WalkIn extends WebSocketMsg
