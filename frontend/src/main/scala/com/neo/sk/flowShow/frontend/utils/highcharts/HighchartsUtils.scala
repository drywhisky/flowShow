...
object HighchartsUtils extends HighchartsImplicits {
  ...
  implicit class HighchartsJQuery(val jq: JQuery) extends AnyVal {
    ...
    def highcharts(): UndefOr[com.neo.sk.flowShow.frontend.utils.highcharts.api.Chart] = {
      jq.asInstanceOf[js.Dynamic].highcharts().asInstanceOf[UndefOr[com.neo.sk.flowShow.frontend.utils.highcharts.api.Chart]]
    }
